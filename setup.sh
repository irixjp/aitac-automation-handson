...
function set_fast_repo () {
    ...
    curl -sL -o /etc/yum.repos.d/aitac-centos.repo https://raw.githubusercontent.com/irixjp/aitac-automation-handson/${VERSION:?}/roles/set_fast_repo/files/aitac-centos.repo
...
function jupyter_launch () {
    ...
    docker run -d \
           ...
           --name aitac-${PORT:?} \
           -e PASSWORD=${PASS:?} \
           irixjp/aitac-automation-jupyter:${VERSION:?}
